...
const routeGetCurl = `curl -X GET https://njordv1.vercel.app/api/v1/route/my_project/users \\
...
const routePostCurl = `curl -X POST https://njordv1.vercel.app/api/v1/route/my_project/users \\
  -H "Content-Type: application/json" \\
  -H "x-njord-token: 3f1d2e9a...64chars" \\
  -d '{
    "name": "Alice",
            ...
            <main className="max-w-4xl mx-auto px-6 py-12 space-y-16">
                ...
                <div className="space-y-4 border-b border-slate-100 pb-12">
                    ...
                    <div className="flex items-center gap-2 pt-1">
                        ...
                        <span className="text-xs text-slate-400">Base URL: <code className="font-mono text-slate-600">https://njordv1.vercel.app/api/v1</code></span>
                    </div>
                </div>
